...
export const translations: Record<Language, Translations> = {
  is: {
    ...
    references: {
      title: "Meðmælendur",
      items: [
        "Gunnhildur - CEO Huxun Simi: 840 4990, Email: gunnhildurarnardottir@ceohuxun.is",
        "Ingimar Andal - One Systems Simi 660 8551, Email: one@one.is",
        "Hrafnkell Erlendsson - One Systems Simi: 660 8553, Email: Hrafnkell@OneSystems.is",
        "Eyvindur Tryggvason - LS Retail - Simi: 616 5050",
        "Íslandspóstur - Íslandspóstur Simi:666 8777",
      ],
    },
  },
  en: {
      ...
      roles: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Also developed insurance solutions in AX Dynamics with X++ and an MVC .NET website using Íslandskluk authentication. The system fetched data directly from AX and stored it with RTS services.",
          ],
        },
      ],
    },
    references: {
      title: "References",
      items: [
        "Gunnhildur - CEO Huxun Phone: 840 4990, Email: gunnhildurarnardottir@ceohuxun.is",
        "Ingimar Andal - One Systems Phone 660 8551, Email: one@one.is",
        ...
        "Íslandspóstur - Íslandspóstur Phone: 666 8777",
      ],
    },
  },
};
